...
export default async function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-cream text-black selection:bg-black selection:text-cream">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t-4 border-black bg-black text-cream py-6">
