...
const adminNavItems = [
  { href: "/", icon: LayoutDashboard, labelKey: "adminNav.dashboard" },
  { href: "/signups", icon: UserPlus, labelKey: "adminNav.signups" },
  { href: "/clients", icon: Users, labelKey: "adminNav.clients" },
